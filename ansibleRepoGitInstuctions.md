...
```python
    cd "C:\Users\Pranjal Verlekar\Documents\VisualStudioCode\ansible"
```
...
```python
    git remote add origin https://github.com/pranjalv91/ansible.git
```
...
```python
    git commit -m "First commit from local ansible directory to ansible repository"
```
